namespace bittorrent.Tests
{
    public class BeencodeTests
    {
        ...
        public void Encode_Dictionary_Simple(string encodedString, string expectedResult)
        {
            var actualResult = new Beencode().Decode(encodedString);
        ...
        [Theory]
        [InlineData("d3:Zatd4:2keyi42e4:1key5:hello4:1234i100ee4:keyx3:ha!e", "{\"key\":{\"key1\":42,\"key2\":\"hello\",\"key3\",100},\"keyx\":\"ha!\"}")]
